<script>
  ...
  import { boardColorHEX } from '$lib/utils'

  import Board from '$lib/components/pages/home/Board.svelte'
...
<main class="home container">
  ...
  <section class="boards">
    ...
    <ButtonCreate title="CRIAR QUADRO" classWidth="" onclick={formCreate.show} />
  </section>
</main>
